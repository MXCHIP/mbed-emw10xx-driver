...
{
    uint32_t  count;
    uint8_t   rates[WL_MAXRATES_IN_SET];
} wl_rateset_t;
...
typedef struct wl_assoc_params_5g
{
    wl_ether_addr_t bssid;
    uint32_t     chanspec_num;
    wl_chanspec_t  chanspec_list[1];
} wl_assoc_params_5g_t;
...
// } wl_join_params_t;
typedef struct wl_join_params_5g
{
    wlc_ssid_t         ssid;
    wl_assoc_params_5g_t  params;
} wl_join_params_5g_t;
...
#define IOVAR_STR_MAXASSOC               "maxassoc"
