...
#define wwd_bus_write_register_value 	wiced_write_register_value
#define wwd_bus_read_register_value     wiced_read_register_value
#define wwd_bus_write_backplane_value 	wiced_write_backplane_value
#define wwd_bus_read_backplane_value    wiced_read_backplane_value
...
extern wiced_result_t  wiced_read_register_value   ( bus_function_t function, uint32_t address, uint8_t value_length, /*@out@*/ uint8_t* value );
...
/* Frame transfer function */
extern /*@only@*/ /*@null@*/ wiced_result_t wiced_read_console(char *console_log, int len);
