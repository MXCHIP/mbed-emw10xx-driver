...
#define wwd_sdpcm_get_iovar_buffer 	wiced_get_iovar_buffer
#define wwd_sdpcm_get_ioctl_buffer 	wiced_get_ioctl_buffer
#define wwd_sdpcm_send_ioctl 	    wiced_send_ioctl
#define wwd_sdpcm_send_iovar 		wiced_send_iovar
