...
typedef enum
{
    BTM_SUCCESS                     = MICO_BT_SUCCESS,                     /* Command succeeded                 */
    BTM_CMD_STARTED                 = MICO_BT_PENDING,                     /* Command started OK.               */
    BTM_BUSY                        = MICO_BT_BUSY,                        /* Device busy with another command  */
    BTM_NO_RESOURCES                = MICO_BT_NO_RESOURCES,                /* No resources to issue command     */
    BTM_MODE_UNSUPPORTED            = MICO_BT_UNSUPPORTED,                 /* Request for 1 or more unsupported modes */
    BTM_ILLEGAL_VALUE               = MICO_BT_ILLEGAL_VALUE,               /* Illegal parameter value           */
    BTM_WRONG_MODE                  = MICO_BT_WRONG_MODE,                  /* Device in wrong mode for request  */
    BTM_UNKNOWN_ADDR                = MICO_BT_UNKNOWN_ADDR,                /* Unknown remote BD address         */
    BTM_DEVICE_TIMEOUT              = MICO_BT_TIMEOUT,                     /* Device timeout                    */
    BTM_BAD_VALUE_RET               = MICO_BT_BAD_VALUE_RET,               /* A bad value was received from HCI */
    BTM_ERR_PROCESSING              = MICO_BT_ERROR,                       /* Generic error                     */
    BTM_NOT_AUTHORIZED              = MICO_BT_NOT_AUTHORIZED,              /* Authorization failed              */
    BTM_DEV_RESET                   = MICO_BT_DEV_RESET,                   /* Device has been reset             */
    BTM_CMD_STORED                  = MICO_BT_CMD_STORED,                  /* request is stored in control block */
    BTM_ILLEGAL_ACTION              = MICO_BT_ILLEGAL_ACTION,              /* state machine gets illegal command */
    BTM_DELAY_CHECK                 = MICO_BT_DELAY_CHECK,                 /* delay the check on encryption */
    BTM_SCO_BAD_LENGTH              = MICO_BT_SCO_BAD_LENGTH,              /* Bad SCO over HCI data length */
    BTM_SUCCESS_NO_SECURITY         = MICO_BT_SUCCESS_NO_SECURITY,         /* security passed, no security set  */
    BTM_FAILED_ON_SECURITY          = MICO_BT_FAILED_ON_SECURITY,          /* security failed                   */
    BTM_REPEATED_ATTEMPTS           = MICO_BT_REPEATED_ATTEMPTS,           /* repeated attempts for LE security requests */
    BTM_MODE4_LEVEL4_NOT_SUPPORTED  = MICO_BT_MODE4_LEVEL4_NOT_SUPPORTED   /* Secure Connections Only Mode can't be supported */
} tBTM_STATUS;
#endif
/*************************
...
/*******************************************************************************
**
** Function         BTM_SetPinCodeOnly
**
** Description      Set Pairing Mode for the device to Latency PIN Code.
**
** Returns          void
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetPinCodeOnly(BOOLEAN pin_code_only);
