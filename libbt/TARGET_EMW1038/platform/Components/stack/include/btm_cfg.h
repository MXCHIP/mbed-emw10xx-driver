 ...
 *
 * IMPORTANT: Must match mico_bt_cfg.h
 */
#pragma once
...
typedef struct
{
    ...
    uint8_t                             scan_filter_policy;                 /**< BLE scan filter policy (TRUE or FALSE) */
...
extern mico_bt_cfg_settings_t *p_btm_cfg_settings;
...
extern mico_bt_cfg_buf_pool_t *p_btm_cfg_buf_pools;
...
**
*******************************************************************************/
BTM_API extern void BTM_CfgStack(const mico_bt_cfg_settings_t *p_bt_new_cfg_settings, 
                                 const mico_bt_cfg_buf_pool_t bt_new_cfg_buf_pools[MICO_BT_CFG_NUM_BUF_POOLS]);
