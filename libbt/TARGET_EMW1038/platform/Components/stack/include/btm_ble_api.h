...
#define BTM_BLE_SCAN_FILTER_POLICY_NONE         0
#define BTM_BLE_SCAN_FILTER_POLICY_WHITE_LIST   1
typedef UINT8 tBTM_BLE_SCAN_FILTER_POLICY;
...
typedef BOOLEAN (tBTM_BLE_SEL_CBACK)(BD_ADDR random_bda, UINT8 *p_remote_name, const UINT8 *p_data, UINT8 length);
...
BTM_API extern void BTM_BleSetScanParams(UINT16 scan_interval, UINT16 scan_window,
                                         tBTM_BLE_SCAN_MODE scan_type, tBTM_BLE_SFP sfp);
...
/*******************************************************************************
**
** Function         BTM_BleGetWhiteListSize
**
** Description      This function is called to get the white list size.
**
** Parameters       dev_wl_type: white list type
**
** Returns          UINT8
**
*******************************************************************************/
BTM_API extern UINT8 BTM_BleGetWhiteListSize(UINT8 dev_wl_type);


/*******************************************************************************
**
** Function         BTM_BleGetWhiteListCapability
**
** Description      This function is called to get the maximum number of devices 
**                  can be added to the white size.
**
** Parameters       void
**
** Returns          UINT8
**
*******************************************************************************/
BTM_API extern UINT8 BTM_BleGetWhiteListCapability(void);
...
**
** Description      This function is called to clear white list.
**
** Parameters       none
**
** Returns          void
**
*******************************************************************************/
BTM_API extern void BTM_BleClearWhiteList(void);
